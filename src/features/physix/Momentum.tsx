...
export const Momentum: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'collision' | 'recoil'>('collision');
    ...
    }, [isPlaying, v1, v2, p1, p2, m1, m2, slowMotion, collisionType, activeTab]);
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">Explore momentum in collisions and recoil.</p>
                    </div>
                </div>
                ...
                <div className="flex bg-gray-100 p-1 rounded-xl">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'collision'
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'recoil'
                                ? 'bg-white text-brand-blue shadow-sm'
                                : 'text-gray-500 hover:text-gray-700'
                            }`}
                    >
